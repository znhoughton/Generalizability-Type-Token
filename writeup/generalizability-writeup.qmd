...
#| fig-cap: "Plot of the RW predictions versus the human results. The results suggest that the model captures the type frequency and token-frequency conditions well, but predicts an effect of stem familiarity where there is none in the human data for the token frequency condition."
#| fig-height: 6
#| fig-width: 7
