...
model_prod_rw_stem_suffix_vary = brm(frequency ~ freq_minus_infreq_stem * freq_minus_infreq_suffix + (1 | participant), #resp_stem intercept removed because it's redundant with freq_minus_infreq_stem
...
model_prod_rw_stem_suffix_vary_by_condition = brm(frequency ~ freq_minus_infreq_stem * freq_minus_infreq_suffix * condition + (1 | participant), #resp_stem intercept removed because it's redundant with freq_minus_infreq_stem
                                       data = human_data_no_sil_no_shoon_plus_rw_preds_stem_suffix_vary,
                                       family = bernoulli(link = 'logit'),
                                       iter = 14000, 
                                       warmup = 7000,
