...
data_cond1_no_stem = data_cond1
#data_cond1_no_stem$Cues = str_extract(data_cond1_no_stem$Cues, "(?<=#_).*")

data_cond2_no_stem = data_cond2
data_cond2_no_stem$Cues = str_extract(data_cond2_no_stem$Cues, "(?<=#_).*")

data_cond3_no_stem = data_cond3
#data_cond3_no_stem$Cues = str_extract(data_cond3_no_stem$Cues, "(?<=#_).*")

data_cond4_no_stem = data_cond4
#data_cond4_no_stem$Cues = str_extract(data_cond4_no_stem$Cues, "(?<=#_).*")

data_cond5_no_stem = data_cond5
data_cond5_no_stem$Cues = str_extract(data_cond5_no_stem$Cues, "(?<=#_).*")

data_cond6_no_stem = data_cond6
#data_cond6_no_stem$Cues = str_extract(data_cond6_no_stem$Cues, "(?<=#_).*")

data_cond1_rw_matrix = map_dfr(1:n_sims, function(i) {
  result = as.data.frame(Rescorla(cuesOutcomes = data_cond1_no_stem[sample(1:nrow(data_cond1_no_stem)), ], logistic = T))
  result = rownames_to_column(result, var = 'cue')
  result$sim = i
  result
})
...
data_cond2_rw_matrix = map_dfr(1:n_sims, function(i) {
  result = as.data.frame(Rescorla(cuesOutcomes = data_cond2_no_stem[sample(1:nrow(data_cond2_no_stem)), ], logistic = T))
  result = rownames_to_column(result, var = 'cue')
  result$sim = i
  result
})
...
data_cond3_rw_matrix = map_dfr(1:n_sims, function(i) {
  result = as.data.frame(Rescorla(cuesOutcomes = data_cond3_no_stem[sample(1:nrow(data_cond3_no_stem)), ], logistic = T))
  result = rownames_to_column(result, var = 'cue')
  result$sim = i
  result
})
...
data_cond4_rw_matrix = map_dfr(1:n_sims, function(i) {
  result = as.data.frame(Rescorla(cuesOutcomes = data_cond4_no_stem[sample(1:nrow(data_cond4_no_stem)), ], logistic = T))
  result = rownames_to_column(result, var = 'cue')
  result$sim = i
  result
})
...
data_cond5_rw_matrix = map_dfr(1:n_sims, function(i) {
  result = as.data.frame(Rescorla(cuesOutcomes = data_cond5_no_stem[sample(1:nrow(data_cond5_no_stem)), ], logistic = T))
  result = rownames_to_column(result, var = 'cue')
  result$sim = i
  result
})
...
data_cond6_rw_matrix = map_dfr(1:n_sims, function(i) {
  result = as.data.frame(Rescorla(cuesOutcomes = data_cond6_no_stem[sample(1:nrow(data_cond6_no_stem)), ], logistic = T))
  result = rownames_to_column(result, var = 'cue')
  result$sim = i
  result
})
...
human_data_no_sil_no_shoon_token_freq_no_stem_activations = human_data_no_sil_no_shoon %>%
  left_join(data_all_conds_for_comparison)
...
model_human_rw_preds_no_stem = brm(frequency ~ freq_minus_infreq + (1 | participant) + (1 | resp_stem),
                                       data = human_data_no_sil_no_shoon_token_freq_no_stem_activations,
                                       family = bernoulli(link = 'logit'),
                                       iter = 15000, 
                                       warmup = 7500,
                                       chains = 4,
                                       ...
                                       #control = list(adapt_delta = 0.99),
                                       save_pars = save_pars(all = TRUE),
                                       file = '../Data/model_human_rw_preds_no_stem')


data_prod_results_for_plotting_stem_suffix_vary_no_stem = data_prod_results_for_stem_plot %>%
  dplyr::select(-dan_activations, -sil_activations, -nem_activations, -shoon_activations, -dv) %>%
  ungroup() %>%
  mutate(label = ifelse(is.stem == 1, 'stem', 'suffix')) %>%
  dplyr::select(-is.stem) %>%
...
human_data_no_sil_no_shoon_plus_rw_preds_no_stem_suffix_vary = human_data_no_sil_no_shoon %>%
  left_join(data_prod_results_for_plotting_stem_suffix_vary_no_stem)


model_prod_rw_stem_suffix_vary = brm(frequency ~ freq_minus_infreq_stem + freq_minus_infreq_suffix + (1 | participant) + (1 | resp_stem), #resp_stem intercept removed because it's redundant with freq_minus_infreq_stem
                                       data = human_data_no_sil_no_shoon_plus_rw_preds_no_stem_suffix_vary,
                                       family = bernoulli(link = 'logit'),
                                       iter = 14000, 
                                       warmup = 7000,
                                       chains = 4,
...
human_data_no_sil_no_shoon_plus_rw_preds_no_stem_suffix_vary$condition = factor(human_data_no_sil_no_shoon_plus_rw_preds_no_stem_suffix_vary$condition, levels = c(3, 1, 2))
...
human_data_no_sil_no_shoon_plus_rw_preds_no_stem_suffix_vary$meaning = factor(human_data_no_sil_no_shoon_plus_rw_preds_no_stem_suffix_vary$meaning)

contrasts(human_data_no_sil_no_shoon_plus_rw_preds_no_stem_suffix_vary$meaning) = contr.sum(levels(human_data_no_sil_no_shoon_plus_rw_preds_no_stem_suffix_vary$meaning))

human_data_no_sil_no_shoon_plus_rw_preds_no_stem_suffix_vary$stem_condition = factor(human_data_no_sil_no_shoon_plus_rw_preds_no_stem_suffix_vary$stem_condition, levels = c('novel', 'familiar'))

contrasts(human_data_no_sil_no_shoon_plus_rw_preds_no_stem_suffix_vary$stem_condition) = contr.sum(levels(human_data_no_sil_no_shoon_plus_rw_preds_no_stem_suffix_vary$stem_condition))
