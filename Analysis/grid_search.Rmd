...
results_lowest_mse = results_all %>%
  ungroup() %>%
  filter(mean_mse == min(mean_mse))
  
results_lowest_mse$SemAlpha
results_lowest_mse$Beta
results_lowest_mse$Alpha

ggplot(data = results_lowest_mse, aes(x = meaning, y = invlogit(mean_freq_diff_v2), fill = prod_condition)) +
