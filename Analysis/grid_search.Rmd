...
```{r}
# If loading results from a previously saved run rather than running the grid
# search above, read them in here:
# results_all_conf    = read_csv('../Data/grid_search_results_conf_alpha.csv')
# pattern_scores_conf = read_csv('../Data/grid_search_scores_conf_alpha.csv')
```
