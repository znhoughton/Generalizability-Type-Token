...
data_analysis_comprehension = data_analysis_comprehension %>%
  mutate(freq_choice = case_when(
    language == 'dan' & comprehension_suffix == 'dan' ~ 'freq',
    language == 'dan' & comprehension_suffix == 'sil' ~ 'freq_competitor',
    language == 'dan' & comprehension_suffix == 'nem' ~ 'infreq',
    language == 'dan' & comprehension_suffix == 'shoon' ~ 'infreq_competitor',
    language == 'nem' & comprehension_suffix == 'nem' ~ 'freq',
    language == 'nem' & comprehension_suffix == 'shoon' ~ 'freq_competitor',
    language == 'nem' & comprehension_suffix == 'dan' ~ 'infreq',
    language == 'nem' & comprehension_suffix == 'sil' ~ 'infreq_competitor'
  ))
...
original_meaning_freq_comprehension_data_cond1 = data_analysis_comprehension %>%
  #filter(task %in% c('2afc')) %>%
  filter((language == 'dan' & comprehension_response == 'big_pl') | (language == 'nem' & comprehension_response == 'dim_sg') & condition == 1) %>%
  ungroup() %>%
  mutate(freq_choice_dv = case_when(
    freq_choice == 'freq' ~ 1,
    .default = 0
...
novel_meaning_freq_comprehension_data_cond1 = data_analysis_comprehension %>%
  #filter(task %in% c('2afc')) %>%
  filter(comprehension_response %in% c('dim_pl') & condition == 1) %>%
  ungroup() %>%
  mutate(freq_choice_dv = ifelse(freq_choice == 'freq', 1, 0))

original_meaning_infreq_comprehension_data_cond1 = data_analysis_comprehension %>%
  #filter(task %in% c('2afc')) %>%
  filter((language == 'nem' & comprehension_response == 'big_pl') | (language == 'dan' & comprehension_response == 'dim_sg') & condition == 1) %>%
  ungroup() %>%
  mutate(freq_choice_dv = case_when(
    freq_choice == 'infreq' ~ 1,
    .default = 0
...
original_meaning_freq_comprehension_data_cond2 = data_analysis_comprehension %>%
  #filter(task %in% c('2afc')) %>%
  filter((language == 'dan' & comprehension_response == 'big_pl') | (language == 'nem' & comprehension_response == 'dim_sg') & condition == 2) %>%
  ungroup() %>%
  mutate(freq_choice_dv = case_when(
    freq_choice == 'freq' ~ 1,
    .default = 0
...
novel_meaning_freq_comprehension_data_cond2 = data_analysis_comprehension %>%
  #filter(task %in% c('2afc')) %>%
  filter(comprehension_response %in% c('dim_pl') & condition == 2) %>%
  ungroup() %>%
  mutate(freq_choice_dv = ifelse(freq_choice == 'freq', 1, 0))

original_meaning_infreq_comprehension_data_cond2 = data_analysis_comprehension %>%
  #filter(task %in% c('2afc')) %>%
  filter((language == 'nem' & comprehension_response == 'big_pl') | (language == 'dan' & comprehension_response == 'dim_sg') & condition == 2) %>%
  ungroup() %>%
  mutate(freq_choice_dv = case_when(
    freq_choice == 'infreq' ~ 1,
    .default = 0
...
original_meaning_freq_comprehension_data_cond3 = data_analysis_comprehension %>%
  #filter(task %in% c('2afc')) %>%
  filter((language == 'dan' & comprehension_response == 'big_pl') | (language == 'nem' & comprehension_response == 'dim_sg') & condition == 3) %>%
  ungroup() %>%
  mutate(freq_choice_dv = case_when(
    freq_choice == 'freq' ~ 1,
    .default = 0
...
novel_meaning_freq_comprehension_data_cond3 = data_analysis_comprehension %>%
  #filter(task %in% c('2afc')) %>%
  filter(comprehension_response %in% c('dim_pl') & condition == 3) %>%
  ungroup() %>%
  mutate(freq_choice_dv = ifelse(freq_choice == 'freq', 1, 0))

original_meaning_infreq_comprehension_data_cond3 = data_analysis_comprehension %>%
  #filter(task %in% c('2afc')) %>%
  filter((language == 'nem' & comprehension_response == 'big_pl') | (language == 'dan' & comprehension_response == 'dim_sg') & condition == 3) %>%
  ungroup() %>%
  mutate(freq_choice_dv = case_when(
    freq_choice == 'infreq' ~ 1,
    .default = 0
