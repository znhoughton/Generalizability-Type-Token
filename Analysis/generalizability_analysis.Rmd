...
write_csv(data_analysis_prod_typos, '../Data/prod_data_typos2.csv')
```
...
data_analysis = data_analysis %>%
  filter(any(native_lang %in% c('english', 'English', 'I am a native english speaker')))
...
m1_smaller = brm(freq_choice ~ condition + stem_condition + task + task:condition + condition:stem_condition
