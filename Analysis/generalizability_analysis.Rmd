...
m1_smaller = brm(freq_choice ~ pretraining + condition + stem_condition + task + task:condition + pretraining:condition + condition:stem_condition + pretraining:stem_condition 
